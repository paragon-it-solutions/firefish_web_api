...
namespace Firefish.API.Controllers
{
    ...
    public class SkillsController(ISkillService skillService) : ControllerBase
    {
        ...
        /// <returns>
        ///     An ActionResult containing an IEnumerable of SkillResponseModel objects.
        ...
        public async Task<ActionResult<IEnumerable<SkillResponseModel>>> Get(int candidateId)
        {
            try
            {
        ...
        /// <returns>
        ///     An ActionResult containing the created SkillResponseModel object if successful.
        ...
        [HttpPost]
        public async Task<ActionResult<SkillResponseModel>> Post(
        ...
        public async Task<ActionResult<IEnumerable<SkillResponseModel>>> Delete(
